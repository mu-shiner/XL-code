...
class Shop extends  AdminBase
{
    ...
    public function shopList()
    {
        ...
        $shoplist = Db::name('shop')->where($where)->paginate(20);
    ...
    {   
        ...
        //var_dump($_POST['goods_content']);die;
        if(isset($_POST['goods_content']) && $_POST['goods_content'] != '')
        {
            $goods_content = str_replace('alt=""', 'style="width:100%"', $_POST['goods_content']);
        }
...
//            $file_name[] = $img_name.$k; //文件名
    ...
    {   
        ...
        $where['is_delete'] = 0;
        //var_dump($where);die;
        $list = Db::name('shop_withdraw')->where($where)->paginate(20);
